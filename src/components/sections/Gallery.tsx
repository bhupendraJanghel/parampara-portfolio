...
export default function Gallery() {
  ...
  return (
    <section id="gallery" className="mx-auto max-w-7xl px-6 py-5">
      ...
      >
        <motion.div
          className={`gallery-card group relative overflow-hidden rounded-[1.8rem] bg-stone-900 md:col-span-1 md:row-span-2 min-h-[300px] md:min-h-0 cursor-pointer transition-all duration-500 ${isCardActive(0) ? "scale-[0.99] border-[#d4af37]/90 shadow-lg" : "border-transparent"
            }`}
          whileTap={{ scale: 0.98 }}
        >
          <Image
        ...
        <motion.div
          className={`gallery-card group relative aspect-video overflow-hidden rounded-[1.8rem] bg-stone-900 md:col-span-2 md:row-span-1 md:aspect-auto cursor-pointer transition-all duration-500 ${isCardActive(1) ? "scale-[0.99] border-[#d4af37]/90 shadow-lg" : "border-transparent"
            }`}
          whileTap={{ scale: 0.98 }}
        >
          <Image
        ...
        <motion.div
          className={`gallery-card group relative aspect-square overflow-hidden rounded-[1.8rem] bg-stone-900 md:col-span-1 md:row-span-1 md:aspect-auto cursor-pointer transition-all duration-500 ${isCardActive(2) ? "scale-[0.99] border-[#d4af37]/90 shadow-lg" : "border-transparent"
            }`}
          whileTap={{ scale: 0.98 }}
        >
          <Image
        ...
        <motion.div
          className={`gallery-card group relative aspect-square overflow-hidden rounded-[1.8rem] bg-stone-900 md:col-span-1 md:row-span-1 md:aspect-auto cursor-pointer transition-all duration-500 ${isCardActive(3) ? "scale-[0.99] border-[#d4af37]/90 shadow-lg" : "border-transparent"
            }`}
          whileTap={{ scale: 0.98 }}
        >
          <Image
        ...
        <motion.div
          className={`gallery-card group relative aspect-square overflow-hidden rounded-[1.8rem] bg-stone-900 md:col-span-1 md:row-span-1 md:aspect-auto cursor-pointer transition-all duration-500 ${isCardActive(4) ? "scale-[0.99] border-[#d4af37]/90 shadow-lg" : "border-transparent"
            }`}
          whileTap={{ scale: 0.98 }}
        >
          <Image
        ...
        <motion.div
          className={`gallery-card group relative aspect-square overflow-hidden rounded-[1.8rem] bg-stone-900 md:col-span-1 md:row-span-1 md:aspect-auto cursor-pointer transition-all duration-500 ${isCardActive(5) ? "scale-[0.99] border-[#d4af37]/90 shadow-lg" : "border-transparent"
            }`}
          whileTap={{ scale: 0.98 }}
        >
          <Image
