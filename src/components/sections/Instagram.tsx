...
export default function Instagram() {
  return (
    <section id="instagram" className="mx-auto max-w-7xl px-6 py-16">
      <div className="mb-8 flex items-end justify-between">
        <h2 className="font-serif text-3xl text-[#1b3225] md:text-4xl">
          Follow the live feed
        </h2>
        <a href="#" className="font-sans text-xs font-bold uppercase tracking-widest text-[#c5a059] transition-colors hover:text-[#1b3225]">
          @paramparaevents
        </a>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 md:grid-cols-5">
        {igImages.map((src, idx) => (
          ...
          >
            <img src={src} alt={`Instagram ${idx}`} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-110" />
